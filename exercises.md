...
**5.5** X רציף עם פונקציית הצפיפות שבאיור. כתבו אלגוריתם דגימה.
...
**5.13** בפייתון:
א. ממשו קבלה-דחייה למשקל של פרי אקראי — 70% תפוחים במשקל U(3,5) ו-30% תפוזים במשקל U(4,8) — עם מעטפת קבועה. מדדו את שיעור הקבלה האמפירי והשוו לחישוב.
